...
$multipart .="Content-Transfer-Encoding: Quot-Printed\n\n";
	...
	$headers .= "Content-Type: text/html; charset=UTF-8\r\n";
		...
		$body = '<html>
		<head></head>
		<body><p>Адрес страницы: '.$_SERVER['SERVER_NAME'].'/HopUp/'.'</p><p>Имя: '.$_POST['form_name1'].'</p><p>Почта: '.$_POST['form_email1'].'</p><p>Вопрос: '.$_POST['form_vopros'].'</p></body>';
